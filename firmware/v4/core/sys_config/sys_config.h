...
#define SYS_CONFIG_FORMAT_VERSION (7) // This should be incremented when/if the sys_config layout is modified
...
#define SYS_CONFIG_GPS_TRIGGER_MODE_SCHEDULED_BITMASK                  (1 << 0)
#define SYS_CONFIG_GPS_TRIGGER_MODE_SALTWATER_SWITCH_TRIGGERED_BITMASK (1 << 1)
#define SYS_CONFIG_GPS_TRIGGER_MODE_ACCEL_TRIGGERED_BITMASK            (1 << 2)
#define SYS_CONFIG_GPS_TRIGGER_MODE_REED_TRIGGERED_BITMASK             (1 << 3)
