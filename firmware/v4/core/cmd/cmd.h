...
#define CMD_VALUES(X) \
    ...
    /* Versioning */ \
    X(CMD_VERSION_REQ,                 cmd_generic_req_t,                 cmd_version_req)                 /* Request the hardware and firmware version information */ \
    X(CMD_VERSION_RESP,                cmd_version_resp_t,                cmd_version_resp)                /* Respond with the hardware and firmware versions */ \
