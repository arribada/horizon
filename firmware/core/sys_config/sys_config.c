...
static const dependancy_lookup_table_t dependancy_lookup_table[] =
{
    ...
    SYS_CONFIG_REQUIRED_IF_MATCH_BITMASK(SYS_CONFIG_TAG_GPS_SCHEDULED_ACQUISITION_INTERVAL,    SYS_CONFIG_TAG_GPS_TRIGGER_MODE, sys_config.gps_trigger_mode.contents.mode, SYS_CONFIG_GPS_TRIGGER_MODE_SCHEDULED_BITMASK, SYS_CONFIG_GPS_TRIGGER_MODE_SCHEDULED_BITMASK),
    SYS_CONFIG_REQUIRED_IF_MATCH_BITMASK(SYS_CONFIG_TAG_GPS_MAXIMUM_ACQUISITION_TIME,          SYS_CONFIG_TAG_GPS_TRIGGER_MODE, sys_config.gps_trigger_mode.contents.mode, SYS_CONFIG_GPS_TRIGGER_MODE_SCHEDULED_BITMASK, SYS_CONFIG_GPS_TRIGGER_MODE_SCHEDULED_BITMASK),
